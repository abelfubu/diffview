...
import { DEFAULT_SIDEBAR_WIDTH, DiffView, DirectoryTreeView, Toast, type DiffViewRef, type DirectoryTreeViewRef } from "./components/index.js";
...
export function App({ parsedFiles, copyNotificationDuration = 2000 }: AppProps): React.ReactNode {
